...
export declare class Schedule extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    tempResourceCollection: ResourcesModel[];
    ...
    /** @hidden */
    isServerRenderer(view?: View): boolean;
    /** @hidden */
    renderCompleted(): void;
    /** @hidden */
    layoutReady(resourceCollection?: Object[], isFirstRender?: boolean, isSetModel?: boolean): void;
    /** @hidden */
    refreshLayout(args: Object[]): void;
    /** @hidden */
    updateLayoutTemplates(): void;
    /** @hidden */
    resetLayoutTemplates(): void;
    /** @hidden */
    updateEventTemplates(): void;
    /** @hidden */
    ...
    /** @hidden */
    setScheduleProperties(properties: object): void;
    /** @hidden */
    ...
    /** @hidden */
    getMsFromDate(date: Date): number;
    /** @hidden */
